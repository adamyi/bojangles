...
def fitness(comps, dna):
  ...
  """
  clash, day, hr = get_fitness_vals(comps, dna)
  return clash_value(clash) + day_value(day) + hr_value(hr)
...
if __name__ == "__main__":
  ...
  for generation in xrange(GENERATIONS):
    try:
      ...
      fits.append(get_fitness_vals(comps, max_fit[0]))
  ...
  x = range(len(fits))
  pyplot.plot(x,[pair[0] for pair in fits], label='clash hour')
  pyplot.plot(x,[pair[1] for pair in fits], label='number of day')
  pyplot.plot(x,[pair[2] for pair in fits], label='total hours')
  pyplot.legend()
  pyplot.show()
